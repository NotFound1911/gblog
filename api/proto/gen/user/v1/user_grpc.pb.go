...
const (
	...
	UserService_UpdateNonSensitiveInfo_FullMethodName = "/users.UserService/UpdateNonSensitiveInfo"
)
...
type UserServiceClient interface {
	...
	UpdateNonSensitiveInfo(ctx context.Context, in *UpdateNonSensitiveInfoReq, opts ...grpc.CallOption) (*UpdateNonSensitiveInfoResp, error)
}
...
func (c *userServiceClient) UpdateNonSensitiveInfo(ctx context.Context, in *UpdateNonSensitiveInfoReq, opts ...grpc.CallOption) (*UpdateNonSensitiveInfoResp, error) {
	out := new(UpdateNonSensitiveInfoResp)
...
type UserServiceServer interface {
	...
	UpdateNonSensitiveInfo(context.Context, *UpdateNonSensitiveInfoReq) (*UpdateNonSensitiveInfoResp, error)
...
func (UnimplementedUserServiceServer) UpdateNonSensitiveInfo(context.Context, *UpdateNonSensitiveInfoReq) (*UpdateNonSensitiveInfoResp, error) {
...
func _UserService_UpdateNonSensitiveInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateNonSensitiveInfoReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UpdateNonSensitiveInfo(ctx, req.(*UpdateNonSensitiveInfoReq))
	}
	return interceptor(ctx, in, info, handler)
}
