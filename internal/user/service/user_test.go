...
import (
	...
	"github.com/NotFound1911/gblog/internal/user/repository"
	repomocks "github.com/NotFound1911/gblog/internal/user/repository/mocks"
			...
			mock: func(ctrl *gomock.Controller) repository.UserRepository {
				...
				repo.EXPECT().
					...
					Return(domain.User{
						...
						// 加密后的正确的密码
						Password: "$2a$10$v00OxCcf4S2Hj..vH.nEVuJQLmfrA0iaZtqNcJbWNJ816c8W6bAqu",
						Phone:    "15212345678",
					}, nil)
				return repo
			},
